...
[Proxy]
KH 1 = vmess, 220.158.233.184, 10000, username=f2bca16a-fa22-11ee-8a84-efabd601e456 ,udp-relay=true, ws=true, ws-path=/vpnjantit, ws-headers=Host:m.mobilelegends.com, vmess-aead=true

TH 1 = vmess, 185.78.165.153, 10000, username=eb9fe36c-fa52-11ee-9aa3-00163ea61c9a ,udp-relay=true, ws=true, ws-path=/vpnjantit, ws-headers=Host:m.mobilelegends.com, vmess-aead=true
